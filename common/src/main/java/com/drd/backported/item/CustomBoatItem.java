...
public class CustomBoatItem extends BoatItem {
    ...
    public CustomBoatItem(boolean hasChest, CustomBoat.Type type, Properties pProperties) {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                CustomBoat boat = this.getBoat(pLevel, hitresult);
    ...
    private CustomBoat getBoat(Level level, HitResult hitResult) {
        return this.hasChest ? new CustomChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) : new CustomBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
    }
}
