...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    }), 8, ModSounds.ARMOR_EQUIP_COPPER, 0.0F, 0.0F, () -> Ingredient.of(Items.COPPER_INGOT));
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionFunctionForType,
                        int enchantmentValue, RegistrySupplier<SoundEvent> sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
