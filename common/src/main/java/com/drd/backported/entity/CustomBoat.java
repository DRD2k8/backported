...
public class CustomBoat extends Boat {
    private static final EntityDataAccessor<Integer> WOOD_TYPE = SynchedEntityData.defineId(CustomBoat.class, EntityDataSerializers.INT);
    ...
    public enum Type {
        PALE_OAK("pale_oak", () -> ModItems.PALE_OAK_BOAT.get(), () -> ModItems.PALE_OAK_CHEST_BOAT.get());
        ...
        public ResourceLocation getTexture(boolean hasChest) {
            if (hasChest) {
                return new ResourceLocation(Backported.MOD_ID, "textures/entity/chest_boat/" + name + ".png");
            }
            return new ResourceLocation(Backported.MOD_ID, "textures/entity/boat/" + name + ".png");
        }
